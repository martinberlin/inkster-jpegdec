...
esp_err_t _http_event_handler(esp_http_client_event_t *evt)
{
    ...
    case HTTP_EVENT_ON_DATA:
        ...
        if (countDataEventCalls == 1)
        {
            ...
            {
                isPaddingAware = true;
                printf("BMP isPaddingAware:  1 bit depth are 4 bit padded. Wikipedia gave me a lesson.");
            }
                          ...
                          int32_t event_id, void *event_data)
{
    ...
    else if (event_base == WIFI_EVENT && event_id == WIFI_EVENT_STA_DISCONNECTED)
    {
        ...
        else
        {
            ...
            printf("Connect to the AP failed %d times. Going to deepsleep %d minutes", 5, DEEPSLEEP_MINUTES_AFTER_RENDER);
            deepsleep();
        }
    }
